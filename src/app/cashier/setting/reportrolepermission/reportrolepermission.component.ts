...
@Component({
  selector: 'app-reportrolepermission',
  templateUrl: './reportrolepermission.component.html',
  styleUrls: ['./reportrolepermission.component.scss']
})
export class ReportrolepermissionComponent implements OnInit {
