...
@Component({
  selector: 'app-netincomereport',
  templateUrl: './netincomereport.component.html',
  styleUrls: ['./netincomereport.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class NetincomereportComponent implements OnInit {
